...
if (isset($file_wap_url)) {
    $sql_img = "UPDATE news SET news_wap_img_url='{$img_wap_url}' WHERE news_id='{$news_id}'";
    $sql_img_finish = mysqli_query($link, $sql_img);
}

$sql_news = "UPDATE news SET news_title='{$news_title}', news_click='{$news_click}', news_summary='{$news_summary}', news_all='{$news_all}',news_img_alt='{$news_img_alt}' WHERE news_id='{$news_id}'";
